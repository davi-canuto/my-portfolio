...
const projects = {
  titiltei: {
    en: {
      ...
      desc: 'Full SaaS platform for streamer Titiltei. Includes LoL matchup guides, video library, learning trails, admin CMS, Stripe checkout, and access control.',
      status: 'active',
    },
    pt: {
      name: 'Titiltei',
      ...
      role: 'Desenvolvedor',
      stack: ['Next.js', 'TypeScript', 'Prisma', 'PostgreSQL', 'Stripe'],
      desc: 'Plataforma SaaS completa para o streamer Titiltei. Inclui guias de matchups de LoL, biblioteca de vídeos, trilhas de aprendizado, CMS admin, checkout com Stripe e controle de acesso.',
      status: 'ativo',
    },
  },
  innovajus: {
